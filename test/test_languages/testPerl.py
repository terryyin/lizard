...
class Test_Perl_Cognitive_Complexity(unittest.TestCase):
    """Cognitive Complexity tests for Perl"""

    def get_perl_functions(self, code):
        return analyze_file.analyze_source_code("test.pl", code).function_list
    ...
    def test_simple_function_has_zero_cogc(self):
        ...
        '''
        functions = self.get_perl_functions(code)
