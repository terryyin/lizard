...
class Test_StructuredText_Cognitive_Complexity(unittest.TestCase):
    """Cognitive Complexity tests for Structured Text"""

    def get_st_functions(self, code):
        return analyze_file.analyze_source_code("test.st", code).function_list
    ...
    def test_simple_function_has_zero_cogc(self):
        ...
        END_FUNCTION
        '''
        functions = self.get_st_functions(code)
