...
class TestOptionParsing(unittest.TestCase):
    ...
    def test_sorting_factor_does_not_exist_error_message(self, mock_stderr, mock_exit):
        options = parse_args(['lizard', '-sdoesnotexist'])
        # Field order changed: cognitive_complexity now appears after length (extension field)
        self.assertEqual("Wrong field name 'doesnotexist'.\nCandidates are: nloc, cyclomatic_complexity, token_count, parameter_count, length, cognitive_complexity, location\n", mock_stderr.getvalue())
    ...
    def test_sorting_factor_does_not_exist_error_message_with_ext(self, mock_stderr, mock_exit):
        ...
        # Field order changed: extension fields (cognitive_complexity, max_nesting_depth) appear after base fields
        self.assertEqual("Wrong field name 'doesnotexist'.\nCandidates are: nloc, cyclomatic_complexity, token_count, parameter_count, length, cognitive_complexity, max_nesting_depth, location\n", mock_stderr.getvalue())
